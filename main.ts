controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    buttonDown = sprites.create(img`
        ...
        ........ffffffffffffffff........
        `, SpriteKind.Player)
    projectile = sprites.createProjectileFromSprite(assets.image`bigStar`, buttonDown, randint(-100, 100), randint(-100, 100))
})
info.onCountdownEnd(function () {
    game.over(true, effects.smiles)
})
controller.A.onEvent(ControllerButtonEvent.Released, function () {
    buttonUp = sprites.create(img`
        ..........666666666666..........
        ........6667777777777666........
...
let buttonUp: Sprite = null
let projectile: Sprite = null
let buttonDown: Sprite = null
scene.setBackgroundImage(img`
    ...
    `)
game.splash("Type A to win scores")
